...
public class ItalianiAmericaFragment extends Fragment {

    private GetRSSDataTask task = null;

    public ItalianiAmericaFragment() {
    ...
    public void do_task(){
        task.execute("https://severitwinnings.wordpress.com/category/studenti-italiani-in-america/feed/");
    }
